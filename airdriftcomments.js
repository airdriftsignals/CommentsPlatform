...
var allComments  = [];
  ...
  function getTenureBadge(email) {
    ...
    if (currentUser && email === currentUser.email) {
      if (!_lastTenureBadge[email]) {
      ...
      } else if (_lastTenureBadge[email] !== earnedTier.label) {
        ...
        if (isZenith) {
          ...
          notifications.unshift({ id:'zenith_unlock_'+Date.now(), type:'system', read:false,
  ...
  function dmChangeUsername() {
    ...
    try {
      ...
      recipNotifs.unshift({
        id: 'rename_' + Date.now(), type: 'system',
  ...
  // ── COMMENT FORMATTING ───────────────────────────────
  // Subscriber+ can use: **bold**, _italic_, >quote, `code`
